...
public class SectionController {
    ...
    public List<SectionEntity> listSectionsByPositionWeb(@PathVariable("position_web") String position_web) {
        return sectionService.listSectionByWebsite(position_web);
    }
